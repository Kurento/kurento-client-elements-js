...
/**
 * An {@link HttpPostEndpoint} contains SINK pads for AUDIO and VIDEO, which provide access to an HTTP file upload function
 * 
 *    This type of endpoint provide unidirectional communications. Its {@link MediaSource MediaSources } are accessed through the <a href="http://www.kurento.org/docs/current/glossary.html#term-http">HTTP</a> POST method.
 *
 * @class module:elements.HttpPostEndpoint
...
/**
 * @type module:elements.HttpPostEndpoint.constructorParams
 *
...
/**
 * @type module:elements.HttpPostEndpoint.events
 *
